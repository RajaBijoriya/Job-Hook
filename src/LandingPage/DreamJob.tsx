    ...
    <div className="flex items-center px-16">
      <div className="flex flex-col w-[45%] gap-3">
        ...
        <div className="flex gap-3 mt-5">
          <TextInput
            className="bg-mine-shaft-900 rounded-lg py-1 px-2 text-mine-shaft-100
          ...
          <div
            className="flex items-center justify-center h-full w-20 
        bg-bright-sun-400 text-mine-shaft-100 rounded-lg p-2 hover:bg-bright-sun-500 cursor-pointer">
      ...
      <div className="w-[55%] flex items-center justify-center">
        <div className="w-[30rem] relative">
          ...
          <div className="w-fit absolute -right-10 top-[50%] border-bright-sun-400 border rounded-lg p-2
          backdrop-blur-md ">
          ...
          <div className="w-fit absolute -left-5 top-[28%] border-bright-sun-400 border rounded-lg p-2 
