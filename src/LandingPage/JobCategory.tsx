...
const JobCategory=() =>{
   return <div className="mt-20 pb-5">
           ...
           text-mine-shaft-100">Browse <span className="text-bright-sun-400">Job
           </span> Category</div>
           <div className="text-lg mx-auto mb-10 text-mine-shaft-300 text-center w-1/2">
            Explore diverse job opportunities tailored to your skills.
             ...
             >
      {
        jobCategory.category.map((category,index)=> <Carousel.Slide>
             ...
             hover:cursor-pointer hover:shadow-[0_0_5px_2px_black] my-5 transition duration-300 ease-in-out !shadow-bright-sun-300">
                ...
                <div className="text-sm text-mine-shaft-300 text-center">{category.decs}</div>
