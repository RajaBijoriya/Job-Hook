    ...
    <div className="mt-20 pb-5">
      ...
      <div className="flex px-16 justify-between items-center">
        <div className="relative">
          ...
          <div className="w-36 flex top-[15%] right-0 absolute flex-col items-center gap-1 border
           border-bright-sun-400 rounded-xl py-3 px-1 backdrop-blur-md">
        ...
        <div className="flex flex-col gap-10">
          {
            work.work.map((item, index) => <div key={index} className="flex items-center gap-4">
