...
const JobDesc = (props:any) => {
  ...
  return (
    <div className="w-2/3">
      <div className="flex justify-between">
        <div className="flex gap-2 items-center">
          ...
          <div className="flex flex-col gap-1">
            <div className="font-medium text-lg">Software Engineer III</div>
            <div className=" text-mine-shaft-300">
             3 days ago &bull; 48 Applicants
            </div>
          </div>
        </div>
      ...
      <Divider my="xl" />
      <div
        className="[&_h4]:text-xl [&_*]:text-mine-shaft-300 [&_h4]:my-5 [&_h4]:font-semibold
      ...
      <div className="text-mine-shaft-300 text-justify">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique, quae? Ratione inventore voluptas necessitatibus? Ullam omnis deleniti amet sed quibusdam, nam placeat facere, pariatur voluptatum architecto quae reiciendis! Aliquam ipsam ad necessitatibus ut, natus praesentium sequi earum vitae repellendus dignissimos?
      </div>
