  ...
  return (
    <div className='w-2/3'>
      <div className='relative'>
        ...
        <img className='rounded-full w-48 h-48 -bottom-1/3
         absolute left-3 border-mine-shaft-950 border-8' src="/avatar.png" alt="" />
        ...
        <Divider mx="xs"  my="xl"/>
         <div className='px-3'>
            ...
            <div className='flex flex-wrap gap-2'>
                {
                   props.skills?.map((skill:any, index:any) => <div key={index} className='bg-bright-sun-400 text-sm font-medium bg-opacity-15 rounded-3xl text-bright-sun-400
             px-3 p-1'>
                {skill}
             </div>) 
                }
